...
The Lore moon and Inbox are a two-way top-level toggle. Selecting the moon reveals Radio; selecting Inbox returns to the album workflows. Press and Merch stay hidden for now.
...
**How to apply:** Keep workflow pages album-only and free of search/grouping controls. Canonicalize old song, artist, focus, and search URL state back to the selected album workflow. The moon opens Lore sections and does not close itself; Inbox is the explicit return action.