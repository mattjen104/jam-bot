...
**How to apply:** Homepage enrichment should discover and persist both roles independently in one bounded crawl. Compact station marks prefer the square icon. Larger surfaces may use the high-resolution logo without changing the icon contract.