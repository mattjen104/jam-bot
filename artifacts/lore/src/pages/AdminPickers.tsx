...
export default function AdminPickers() {
  ...
  return <PickersPanel token={token} onClearToken={clearToken} />;
}
  ...
  return (
    <div className="rounded-2xl border border-card-border bg-card p-6">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        ...
        validated against the NTS API and enrolled as a curator picker — the
...
function LabelForm({ token }: { token: string }) {
  ...
  return (
    <div className="rounded-2xl border border-card-border bg-card p-6">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Seed a label picker from a verified MusicBrainz label MBID. Every
