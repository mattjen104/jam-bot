  ...
  return [
    {
      ...
      streamQuality: "128kbps AAC",
      streamFormat: "aac",
      homepageUrl: "https://www.wjcu.org/",
      scheduleUrl: "https://www.wjcu.org/programs/schedule",
      nowPlayingSource: "station_history_json",
      nowPlayingConfig: {
        url: "https://studio.creek.org/api/tracks?include=broadcast&studioId=s-wjcu",
        itemsPath: "data",
        idPath: "id",
        artistPath: "song.artist",
        titlePath: "song.title",
        albumPath: "song.album",
        isrcPath: "song.isrc",
        recordingIdPath: "song.musicbrainz_id",
        playedAtPath: "start",
        showPath: "broadcast.show.title",
        sourceKey: "wjcu",
        sourceFamily: "official_api",
        cursorMode: "fixed_feed",
        supportedDepthDays: 1,
        archiveUrl: "https://www.wjcu.org/programs/playlists",
      },
      source: "curated",
      tier: "longtail",
      stationClass: "community",
    ...
    },
    {
      ...
      nowPlayingSource: "radio_browser_icy",
      nowPlayingConfig: { streamUrl: "https://listen.xray.fm/stream" },
      source: "curated",
      tier: "longtail",
      stationClass: "community",
      automationClass: "human",
    ...
    },
    {
      ...
      nowPlayingSource: "radio_browser_icy",
      nowPlayingConfig: { streamUrl: "https://kuvo.streamguys1.com/kuvo-mp3-128" },
      source: "curated",
      tier: "longtail",
      stationClass: "community",
      automationClass: "human",
    ...
    },
    {
      ...
      city: "Cleveland",
      region: "OH",
      streamUrl: "https://wruw-stream.wruw.org/stream.m3u8",
      streamQuality: "Official adaptive HLS stream",
      streamFormat: "hls",
...
function spinitronCollegeStations(): InsertStation[] {
  ...
  return [
    ...
    },
    {
      ...
      streamQuality: "128kbps MP3",
      streamFormat: "mp3",
      homepageUrl: "https://www.wxdu.org/",
      scheduleUrl: "https://www.wxdu.org/schedule/",
      // The official site's favicon is the WXDU roundel. Its separate,
      // higher-resolution header wordmark is suited to larger station marks.
      stationIconUrl: "https://www.wxdu.org/favicon.ico",
      stationIconSource: "curated",
      stationIconWidth: 96,
      stationIconHeight: 96,
      logoUrl: "https://www.wxdu.org/_next/static/media/logo.f59979ff.png",
      logoSource: "curated",
      logoWidth: 896,
      logoHeight: 295,
    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          logoWidth: sql`CASE WHEN ${stationsTable.logoUrl} IS NULL THEN EXCLUDED.logo_width ELSE ${stationsTable.logoWidth} END`,
          logoHeight: sql`CASE WHEN ${stationsTable.logoUrl} IS NULL THEN EXCLUDED.logo_height ELSE ${stationsTable.logoHeight} END`,
          ...
          stationIconWidth: sql`CASE WHEN ${stationsTable.stationIconUrl} IS NULL THEN EXCLUDED.station_icon_width ELSE ${stationsTable.stationIconWidth} END`,
          stationIconHeight: sql`CASE WHEN ${stationsTable.stationIconUrl} IS NULL THEN EXCLUDED.station_icon_height ELSE ${stationsTable.stationIconHeight} END`,
