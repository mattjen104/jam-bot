...
import { applyStationLocationMigration, backfillCoarseStationLocations } from "./lore/station-location-migration.js";
import { applyStationCullMetadataMigration } from "./lore/station-cull-metadata-migration.js";
...
import { applySpinShowAttributionMigration } from "./lore/spin-show-attribution-migration.js";
...
async function bootLore(): Promise<void> {
  try {
    ...
    await runMigration("applySpinShowAttributionMigration", applySpinShowAttributionMigration);
